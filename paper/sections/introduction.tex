...
depends on the cause of failure. \citet{CraiuReiser2006} studied conditional
...
\Cref{sec:application} demonstrates the sensitivity analysis workflow on the
turbine engine data of \citet{Huairu-2013}.
