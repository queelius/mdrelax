...
The proof follows from the definition of the series system minimum and the
independence of component lifetimes; see \citep{towell2023reliability} for
details.
...
This follows immediately from \Cref{thm:joint-T-K} and Bayes' theorem;
see \citep{towell2023reliability}.
...
The proof proceeds by summing over $K_i$ and applying C1, C2, C3 in sequence
to factor and then eliminate the masking probability; see
\citep{towell2023reliability} for the full derivation.
