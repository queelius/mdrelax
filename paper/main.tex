...
with scale parameters showing substantial bias (up to 40\% relative error)
under strong informative masking, compounded by occasional extreme outlier
estimates driven by near-singular Fisher information. Since the masking mechanism and component parameters are
