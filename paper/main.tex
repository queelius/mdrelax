...
failed component. Simulation studies quantify the bias from incorrectly
assuming standard conditions when masking is informative (C2 violation) or
parameter-dependent (C3 violation), and demonstrate that the framework extends
to Weibull series systems. We implement these methods in the \texttt{mdrelax}
R package.
\end{abstract}
